...
insert  into `addparty`(`candidatename`,`partyname`,`areaname`,`image`) values ('raj','BJP','ameerpet','raj');
...
insert  into `register`(`username`,`password`,`contact`,`email`,`address`) values ('ram','ram','7878787878','ram@gmail.com','hyderabad'),('Venket Rao','venkat','3434343434','venkat@gmail.com','hyderabad');
